...
/*!
  \file Cabana_CommunicationPlanHelpers.hpp
  \brief Helpers for multi-node communication patterns
*/
#ifndef CABANA_COMMUNICATIONDPLANHELPERS_HPP
#define CABANA_COMMUNICATIONDPLANHELPERS_HPP
...
#endif // CABANA_COMMUNICATIONDPLANHELPERS_HPP